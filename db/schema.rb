...
ActiveRecord::Schema[7.2].define(version: 2026_06_28_155744) do
  ...
  create_table "potential_matches", force: :cascade do |t|
    ...
    t.index ["user_1_id"], name: "index_potential_matches_on_user_1_id"
    t.index ["user_2_id"], name: "index_potential_matches_on_user_2_id"
  end
  ...
  add_foreign_key "potential_matches", "matches"
  add_foreign_key "potential_matches", "users", column: "liked_by_id"
  add_foreign_key "potential_matches", "users", column: "user_1_id"
  add_foreign_key "potential_matches", "users", column: "user_2_id"
end
